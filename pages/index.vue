<template>
  <section>
    <div class="login">
      <form @submit.prevent="applogin">
        <input type="text" name="username" placeholder="Username" v-model="username" value />
        <input type="password" name="password" placeholder="password" v-model="password" value />
